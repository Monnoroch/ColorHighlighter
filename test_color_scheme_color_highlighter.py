...
if not running_in_st():
    ...
    import unittest
    from mockito import mock, when, verify, captor, ANY
    from xml.etree import ElementTree

    from . import sublime

    from .color_scheme_color_highlighter import ColorSchemeColorHighlighter, ColorSchemeBuilder
    from .color_scheme import ColorSchemeData
    from .regions import NormalizedRegion
    from .settings import ColorSchemeColorHighlighterSettings
    ...
    class ColorSchemeBuilderTest(unittest.TestCase):
        ...
        def test_get_scopes(self):
            ...
            color_scheme_builder = ColorSchemeBuilder(data, color_scheme_writer)
            color = "#FFFFFFFF"
