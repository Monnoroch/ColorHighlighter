...
if not st_helper.running_in_st():

    import unittest
    from mockito import when, unstub

    from .settings import Settings, ColorSchemeColorHighlighterSettings, GutterIconsColorHighlighterSettings
    ...
    class SettingsTest(unittest.TestCase):
        ...
        def test_create(self):
            ...
            self.assertEqual({"selection": True, "all_content": True}, settings.search_colors_in.color_searcher_names)
